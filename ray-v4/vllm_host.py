...
def build_app(args: dict):
    ...
    if len(configs) == 1:
        ...
        console.print(f"[bold yellow]  ⚙️  Ray actor options: {ray_actor_options}[/bold yellow]")
        ...
        console.print(f"[bold yellow]  ⚙️  Router actor options: {router_actor_options}[/bold yellow]")
